<template>
  <form @submit.prevent="submitForm">
    <div class="form-control">
      ...
      <input id="user-name" name="user-name" type="text" v-model="userName" ref="usernameref"/>
    </div>
    <div class="form-control">
      <label for="age">Your Age (Years)</label>
      <input id="age" name="age" type="number" v-model="age" ref="userageref" />
    </div>
    <div class="form-control">
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      console.log(this.$refs.userageref.value +5);
      this.userName = '';
    },
  },
};
